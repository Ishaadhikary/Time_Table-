from timetest import TimeTableGenerator
from timetest import Activity
from timetest import ClassRoom
from timetest import Group


def run():
#since we have available of four classrooms where six groups are needed to be placed
    classRooms = [
        ClassRoom(0),
        ClassRoom(1),
        ClassRoom(2),
    ...
    groups = [
        Group(
            1,
            [
                Activity(1, "Maths 101", 5, 7, [0, 1]), #here we are passing group num, start and end time, days and subj code 
                Activity(1, "PHYS 101", 6, 7, [3, 5]), #the days here have been assigned randomly taking examples as the classes like ours 
        ...
        Group(
            2,
            [
                Activity(2, "COMP 204", 7, 9, [2]), #some classes to be studied for a day 
                Activity(2, "", 5, 7, [3, 6]), #some for two 
                Activity(2, "", 6, 8, [4]),
                Activity(2, "", 9, 10, [1]),
